...
const DIALOGUE_LOOP_CLOSED = "res://dialogues/chapter_3/rus_guard_east_loop_1.txt"
const DIALOGUE_LOOP_OPEN = "res://dialogues/chapter_3/rus_guard_east_loop_2.txt"
const DIALOGUE_LOOP_RECLOSED = "res://dialogues/chapter_3/rus_guard_east_loop_3.txt"
...
func _ready():
	...
	father.connect("father_let_go", self, "close_gate")
	idle_animate()
	state = states.CLOSED
