...
const DIALOGUE_LOOP_CLOSED = "res://dialogues/chapter_9/mongol_guard_loop.txt"
const DIALOGUE_LOOP_OPEN = "res://dialogues/chapter_9/mongol_guard_loop.txt"
...
func open_gate_command():
	get_tree().call_group("guard_noyan", "open_gate")
